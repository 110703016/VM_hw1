...
static char *myname = "steven";
static int myage = 20;
static int mybirthday[2] = { 5, 17 };
static int arr_argc = 0;

module_param(myname, charp, 0000);
MODULE_PARM_DESC(myname, "A name");
module_param(myage, int, S_IRUSR | S_IWUSR | S_IRGRP | S_IROTH);
MODULE_PARM_DESC(myage, "An age");
module_param_array(mybirthday, int, &arr_argc, 0000);
MODULE_PARM_DESC(mybirthday, "An array of birthday");
